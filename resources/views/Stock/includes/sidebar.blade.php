<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-barcode"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> Les Produits</span>
                        <ul class="menu-content">
                            <li >
                                <a class="menu-item" href="{{ route('stock.ProductList') }}" data-i18n="nav.dash.ecommerce">
                                    La Liste  </a>
                            </li>
                            <li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                <span class="menu-title" data-i18n="nav.dash.main"> Les Fournisseurs</span>
                    <ul class="menu-content">
                        <li >
                            <a class="menu-item" href="{{ route('stock.ProviderList') }}" data-i18n="nav.dash.ecommerce">
                                La Liste  </a>
                        </li>
                        <li>
                            <a class="menu-item" href="{{ route('stock.ProviderCreate') }}" data-i18n="nav.dash.crypto">
                                Ajouter Nouveau </a>
                        </li>
        ...
        <li class="nav-item"><a href=""><i class="la la-group"></i>
            <span class="menu-title" data-i18n="nav.dash.main"> Les livraisons</span>
                <ul class="menu-content">
                    <li >
                        <a class="menu-item" href="{{ route('stock.DeliveryList') }}" data-i18n="nav.dash.ecommerce">
                            La Liste  </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{ route('stock.DeliveryCreate') }}" data-i18n="nav.dash.crypto">
                            Ajouter Nouveau </a>
                    </li>
